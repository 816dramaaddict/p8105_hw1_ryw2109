...
The mean of the logical vector indicating whether elements of the sample are greater than 0 is `r logical_vector_mean_official`. This value does not have any meaning as it is only the mean of the False (0) and True (1) contained in this vectors.
...
The mean of the factor vector of length 10, with 3 different factor “levels” `r factor_vector_mean_official`. There is no mean computed as the factor vector does not contain integers as well.
